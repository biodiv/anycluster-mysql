...
Anycluster.prototype = {
	...
	markerFinalClickFunction : function(mapmarker) {
		...
		if (this.clusterMethod == "kmeans" || this.clusterMethod == "centroid") {
	...
	getClusters : function(geoJson, geometry_type, gotClusters, cache){
		...
		xhr.onreadystatechange = function(){
			if (xhr.readyState==4 && xhr.status==200) {
				...
				else if (clusterer.clusterMethod == 'kmeans' || clusterer.clusterMethod == 'centroid'){
	...
	getClusterContent : function(cluster, gotClusterContent){
		...
		var url = encodeURI(this.baseURL + 'getClusterContent/' + this.clusterMethod + "/" + this.zoom + '/' + this.gridSize + '/');
